...
const getFooter= async ()=>{
    const  response = await getData('Footer') 
    setFooter(response);
        console.log(Footer)
}
...
<>
    <section className="pt-5 Footer">
        <div className="container-footer pt-4">
            <div className="row-footer g-4">

                <div className="col-md-6 col-lg-5 col-12 ft-1 f1">
                    <div className="footer-image">
                        <img className='img-footer img-fluid' src={"./img/landingPageImg/img.png"} alt='img'  />
                    </div>

                    <pre className='pre-footer mt-3'>Match way these she avoids seeing
